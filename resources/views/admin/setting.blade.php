   ...
   <div id="content">
    ...
    <div class="container">
       <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
         <a class="nav-link active login-h" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">อาการเจ็บป่วย โรคประจำตัว</a>
      </li>
      <li class="nav-item">
         <a class="nav-link login-h" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">ช่่องทางการชำระเงิน</a>
      </li>
      <li class="nav-item">
         <a class="nav-link login-h" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">ประวัติการแพ้ยา</a>
      </li>
   </ul>
   <div class="tab-content" id="myTabContent">
     <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">เพิ่มอาการแพ้ยา</div>
     <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">ช่องทางการชำระเงิน</div>
